...
file_writer_tool_sumary = FileWriterTool(filename = "summary.txt", directory = "meeting_minutes")
...
class MeetingMinutesCrew():
    ...
    def meeting_minutes_summarizer(self) -> Agent:
        return Agent(
            ...
            tools = [file_writer_tool_sumary, file_writer_tool_action_items, file_writer_tool_sentiment]
        )
